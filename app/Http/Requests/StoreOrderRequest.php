...
{
    /**
     * Коди українських мобільних операторів — і тільки вони.
     ...
     *
     * Міські номери (044 Київ, 032 Львів тощо) свідомо НЕ приймаємо —
     * за рішенням замовника форма збирає лише мобільні.
     */
    ...
    public function rules(): array
    {
        return [
             ...
             * код мобільного оператора, далі рівно 7 цифр: ні більше, ні менше.
             */
    ...
    /** Номер у вигляді 0XXXXXXXXX з кодом реального мобільного оператора. */
    private function phonePattern(): string
    {
        return '/^0('.implode('|', self::MOBILE_CODES).')\d{7}$/';
    }
